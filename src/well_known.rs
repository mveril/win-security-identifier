...
pub const WORLD: ConstSid<1> =
    ConstSid::new( SidIdentifierAuthority::SECURITY_WORLD_AUTHORITY, [0]);

/// Local SID (S-1-2-0)
pub const LOCAL: ConstSid<1> =
    ConstSid::new( SidIdentifierAuthority::SECURITY_LOCAL_AUTHORITY, [0]);
...
pub const NETWORK_SERVICE: ConstSid<1> =
    ConstSid::new( SidIdentifierAuthority::NT_AUTHORITY, [20]);
